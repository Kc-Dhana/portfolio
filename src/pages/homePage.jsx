...
useEffect(() => {
  ...
  const projects = [
    ...
    {
      title: "A+ Auto Care",
      description: "A C# desktop application for auto service management with admin, reception, and accountant dashboards for users, billing, and inventory.",
    ...
    },
      {
        ...
        description: "A full-stack MERN blog application allowing users to register, create, edit, and view posts with authentication.",
