...
export default function Homepage() {
  ...
  // On mount and on darkMode change, toggle the .dark class on <html> and save to localStorage
  useEffect(() => {
          ...
          {projects.map((p, i) => (
            ...
            >
              ...
              <div className="flex gap-4">
                <a href={p.demo} className="text-indigo-600 hover:underline">
                  Live Demo
                </a>
                <a href={p.github} className="text-indigo-600 hover:underline">
                  GitHub
                </a>
              </div>
            </div>
      ...
      <section id="skills" className="py-20 px-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {skills.map((s, i) => (
            <span
              key={i}
              className="bg-indigo-100 dark:bg-indigo-800 dark:text-white text-indigo-800 px-4 py-2 rounded-full text-sm font-medium"
            >
              {s}
            </span>
          ))}
